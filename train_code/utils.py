...
def color_shift(image1, image2, mode='uniform'):
    ...
    # комбіноване перетворення кольорів
...
def color_ss_map(image, seg_num=200, power=1,
    ...
    # використання алгоритму felzenszwalb для сегментації зображення
    ...
    # ініціалізація та об'єднання регіонів на основі схожості
